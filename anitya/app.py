...
def create(config=None):
    ...
    latestStableVersionAndDate_view = api_v2.LatestStableVersionAndDateResource.as_view(
        "apiv2.dates"
    )
    app.add_url_rule(
        "/api/v2/latestStableVersionAndDate/",
        view_func=latestStableVersionAndDate_view,
        methods=["GET"],
    )
